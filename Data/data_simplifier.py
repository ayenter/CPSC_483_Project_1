...
file_name_train_predictors = "train_indexes.npy"
file_name_test_predictors = "test_indexes.npy"
...
np.save(file_name_train_predictors, train_indexes)
np.save(file_name_test_predictors, test_indexes)
